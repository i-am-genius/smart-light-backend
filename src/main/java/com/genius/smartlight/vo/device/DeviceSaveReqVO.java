...
public class DeviceSaveReqVO {
    ...
    @Schema(description = "设备类型。lamp 表示普通灯控设备，cam 表示跟踪摄像头设备，camlamp 表示旧摄像头灯设备，cam_capture 表示专用拍照控制器", example = "lamp", allowableValues = {"lamp", "cam", "camlamp", "cam_capture"}, requiredMode = Schema.RequiredMode.REQUIRED)
